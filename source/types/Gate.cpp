...
void Gate::setStartPos(QPoint pos)
{
	...
	m_gateLine.setP1(QPointF(
		m_startPos.x() * FrameProvider::m_videoMeta.WIDTH,
		m_startPos.y() * FrameProvider::m_videoMeta.HEIGHT
	));
}
...
void Gate::setEndPos(QPoint pos)
{
	...
	m_gateLine.setP2(QPointF(
		m_endPos.x() * FrameProvider::m_videoMeta.WIDTH,
		m_endPos.y() * FrameProvider::m_videoMeta.HEIGHT
	));
...
void Gate::initGate()
{
	...
	m_timelineCounter.resize(FrameProvider::m_videoMeta.FRAMECOUNT, 0);
}
